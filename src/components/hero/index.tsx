        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-16">
          <div className="flex-1 text-center md:text-left">
            ...
            >
              <div className="relative inline-block">
                <motion.div
                  ...
                  animate={reduce ? {} : { scale: [1, 1.15, 1], opacity: [0.2, 0.35, 0.2] }}
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={t({ delay: 0.8, duration: 0.6 })}
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={t({ delay: 1.0, duration: 0.6 })}
              className="space-y-4"
            >
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={t({ delay: 1.2 + index * 0.1 })}
                    >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={t({ delay: 1.4, duration: 0.5 })}
          ...
          <div className="relative mt-12 h-[280px] w-full md:mt-0 md:flex-1 md:h-[440px] lg:h-[480px] hidden sm:block">
            ...
            <motion.div
              ...
              animate={reduce ? {} : { scale: [1, 1.1, 1], opacity: [0.4, 0.6, 0.4] }}
              transition={t({ duration: 8, repeat: Infinity, ease: 'easeInOut' })}
            />
          </div>
        </div>
      </div>
